...
import { ActionStrategy, CardsController, Elemental, Field, InGameStage, Logger, Message, MobData, SelectiveElement, Stage, Team, Timer, Turn, User, UsersStorage } from "./Class"
...
export type ServerGameUserState = ServerUserDrafts & ServerUserFields & ServerUserCards & ServerUser
...
export type ServerGameTeamState<T = ServerGameUserState> =  ServerTeam<T> & ServerTeamPoints
...
export type ServerRoomProps = Omit<ServerRoomPropsPayload, 'password' | 'type' | 'name'>
...
export type ServerFullTeamState = ServerGameTeamState<ServerFullUserState> & ServerRoomTeamState<ServerFullUserState>
...
export type LogPayload = Partial<Omit<Log, 'action' | 'date' | 'timestamp' >> & Pick<Log, 'action'>
...
export type HighlightElementConfigForGetActions = Omit<HighlightElementConfig, 'available'>
...
export type GameProcessUpdateAllStatePayload = {
    teams: (Omit<ServerGameTeamState, 'users'> & { users: (ServerUserFields & ServerUserCards)[] })[]
}

export type DraftUpdateAllStatePayload = Pick<ServerGameState, 'guilds'> & { teams: {
...
export type GameStatePayload = Pick<ServerGameState, 'guilds' | 'teams'>
...
export type InGameStageControllerDefaultData = ServerGameState & { currentUser: User | null }
...
export type InteractionType = 'guild' | 'value'
...
export type WebsocketEvents = typeof WEBSOCKET_EVENTS[keyof typeof WEBSOCKET_EVENTS]