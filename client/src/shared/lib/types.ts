...
import { ListArgs } from "./services/EntityController"
...
type PosAccordingPosType<T extends PosType> = T extends "fixed" | "auto"
    ? Pos
    : T extends "auto-row"
      ? RowPos
      : ColumnPos
...
export type GetEntitiesListPayload<D extends object = {}> =
    CommonListPayload<D> & { key: string }

export interface EntitiesAPI<
    T extends object = object,
    D extends object = {},
    R extends object = object,
> extends HTTPAxiosAPI {
    getList?(
        payload: GetEntitiesListPayload<D>
    ): ApiResponse<ServerListResponse<T>>
...
export type AddNotificationPayload = Pick<Notification, "message" | "type"> &
    Partial<Pick<Notification, "title" | "variant">> & {
        expireTime?: number
    }
