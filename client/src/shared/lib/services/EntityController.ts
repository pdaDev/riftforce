    ...
    constructor({
        ...
        if (workStatus) {
            const initWorkStatus: IWorkStatus = {
                filtering:
                    workStatus?.filtering ?? DEFAULT_WORK_STATUS.filtering,
                sorting: workStatus?.sorting ?? DEFAULT_WORK_STATUS.sorting,
                pagination:
                    workStatus?.pagination ?? DEFAULT_WORK_STATUS.pagination,
            }
